package net.prover.chaining

import net.prover._
import net.prover.controllers.BookModification
...
import net.prover.model.definitions.{BinaryConnective, BinaryJoiner, BinaryRelation}
