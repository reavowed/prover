...
import net.prover.controllers.models.{StandalonePropertyDefinitionSummary, TypeDefinitionSummary, TypeRelationDefinitionSummary}
import net.prover.shorthands.model.entries.DisplayShorthand
import net.prover.structure.datatransfer.DefinitionSummary
