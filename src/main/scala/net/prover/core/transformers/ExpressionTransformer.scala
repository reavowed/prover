...
object ExpressionTransformer {
  ...
  trait WithCommonCompoundExpressionTransformation[TOutput[+_], TParameters] extends ExpressionTransformer[TOutput, TParameters] {
    def transformCompoundStatementWithContext(
      ...
      transformCompoundExpressionWithContext[CompoundStatement, Statement](compoundStatement, parameters)
    }
    def transformCompoundTermWithContext(
      ...
      transformCompoundExpressionWithContext[CompoundTerm, Term](compoundTerm, parameters)
    }
