    ...
    with ExpressionTransformer.DefaultCompoundExpressionTransformation[Try, ApplicationParameters]
{
  ...
  def applySubstitutions(statement: Statement, substitutions: Substitutions)(implicit contextWithExternalDepth: model.substitutions.ContextWithExternalDepth): Try[Statement] = {
