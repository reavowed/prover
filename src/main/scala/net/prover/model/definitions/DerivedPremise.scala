...
sealed trait DerivedPremise {
  ...
  def getSubstitutedPremises(substitutions: Substitutions)(implicit substitutionContext: SubstitutionContext): Option[(Seq[Statement], Seq[Step.InferenceApplicationWithoutPremises])]
}
