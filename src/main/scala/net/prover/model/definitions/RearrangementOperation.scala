...
sealed trait RearrangementOperation {
  ...
  def rearrangementStep[T <: Expression](terms: Seq[Term], direction: Direction, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = {
    direction.getSource(
...
object RearrangementOperation {
  trait Unary extends RearrangementOperation {
    ...
    def rearrangementStep[T <: Expression](a: Term, wrapper: Wrapper[Term, T], expansion: Expansion[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(Seq(a), wrapper, expansion)
    def reversedRearrangementStep[T <: Expression](a: Term, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = reversedRearrangementStep(Seq(a), wrapper, expansion, reversal)
    def rearrangementStep[T <: Expression](a: Term, direction: Direction, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(Seq(a), direction, wrapper, expansion, reversal)
  }
  trait Binary extends RearrangementOperation {
    ...
    def rearrangementStep[T <: Expression](a: Term, b: Term, wrapper: Wrapper[Term, T], expansion: Expansion[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(Seq(a, b), wrapper, expansion)
    def reversedRearrangementStep[T <: Expression](a: Term, b: Term, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = reversedRearrangementStep(Seq(a, b), wrapper, expansion, reversal)
    def rearrangementStep[T <: Expression](a: Term, b: Term, direction: Direction, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(Seq(a, b), direction, wrapper, expansion, reversal)
  }
  trait Ternary extends RearrangementOperation {
    ...
    def rearrangementStep[T <: Expression](a: Term, b: Term, c: Term, wrapper: Wrapper[Term, T], expansion: Expansion[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(Seq(a, b, c), wrapper, expansion)
    def reversedRearrangementStep[T <: Expression](a: Term, b: Term, c: Term, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = reversedRearrangementStep(Seq(a, b, c), wrapper, expansion, reversal)
    def rearrangementStep[T <: Expression](a: Term, b: Term, c: Term, direction: Direction, wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(Seq(a, b, c), direction, wrapper, expansion, reversal)
  }
}
...
case class Commutativity(operator: BinaryOperator, inferenceExtraction: InferenceExtraction) extends RearrangementOperation.Binary {
  ...
  override def reversedRearrangementStep[T <: Expression](terms: Seq[Term], wrapper: Wrapper[Term, T], expansion: Expansion[T], reversal: Reversal[T])(implicit stepContext: StepContext): Option[RearrangementStep[T]] = rearrangementStep(terms.reverse, wrapper, expansion)
}
