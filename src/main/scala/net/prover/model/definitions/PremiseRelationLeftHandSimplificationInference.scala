...
case class PremiseRelationLeftHandSimplificationInference(inference: Inference, premise: Statement, conclusion: Statement, extractionInferences: Seq[Inference]) extends PremiseSimplifier {
