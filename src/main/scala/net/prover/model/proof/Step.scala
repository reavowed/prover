...
object Step {
  ...
  case class InferenceExtraction(assertion: Step.Assertion, extractionSteps: Seq[Step.InferenceApplication]) extends Step.AssertionOrExtraction with Step.Autogenerated {
