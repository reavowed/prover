...
export function TermDefinition(props) {
  ...
  return <ExpressionDefinition title="Term Definition" definition={definition} setDefinition={setDefinition} availableEntries={availableEntries} parser={parser} hasDisambiguator {...otherProps}>
